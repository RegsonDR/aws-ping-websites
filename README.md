...
```bash
aws cloudformation delete-stack --stack-name ping-websites
```
...
## Visualization 
An example of a python script is included under the script folder to create a graph of the request status codes, juypter was used to display the graph in a web interface. 
